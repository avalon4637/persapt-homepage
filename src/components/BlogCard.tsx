...
export default function BlogCard({
  ...
  return (
    <motion.a
      ...
      className="group block rounded-2xl border border-border bg-card/50 backdrop-blur-sm p-6 md:p-8 hover:border-accent/30 hover:bg-card-hover transition-all duration-500"
    >
      {/* Tags */}
      <div className="flex flex-wrap gap-2 mb-4">
